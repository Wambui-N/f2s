...
export function EnhancedPreview({ 
    ...
    return (
      <div className="mt-6">
        <div className="bg-gray-100 p-4 rounded-lg">
          <div className="text-sm text-gray-600 mb-2">Embed Preview (simulated host page)</div>
          <div className="bg-white p-6 rounded border">
            <div className="text-sm text-gray-500 mb-4">Host page content...</div>
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Form Preview */}
      <div ref={previewRef} className={`${getDeviceStyles()} transition-all duration-300`}>
        <Card className="shadow-lg">
          <CardContent className="p-6">
            <div className="space-y-4">
              ...
              {fields.map((field, index) => renderFieldWithSampleData(field, index))}
