  ...
  const features = [
    {
      ...
      description: "Native integration, not an add-on. Real-time sync, two-way updates, and validations directly from Sheets.",
      color: "blue"
    },
    {
      icon: (
      ...
      description: "Modern, mobile-first forms with your logo, colors, and fonts. AI design helper matches your website automatically.",
      color: "purple"
    },
    {
      icon: (
      ...
      description: "Uploads stored neatly in Google Drive with automatic renaming. Dead-simple for SMBs to access and manage.",
      color: "green"
    },
    {
      icon: (
      ...
      description: "Drag boxes, connect arrows, done. Simple conditional logic that SMBs understand without a manual.",
      color: "orange"
    },
    {
      icon: (
    ...
    },
    {
      ...
      description: "Set validation rules directly in your Google Sheets. Dropdowns, required fields, and data types sync automatically.",
      color: "teal"
    },
    {
      icon: (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className={`w-16 h-16 bg-gradient-to-r ${getColorClasses(feature.color)} rounded-2xl flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform duration-300`}>
                {feature.icon}
              </div>
